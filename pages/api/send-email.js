...
export default async function handler(req, res) {
  ...
  let transporter = nodemailer.createTransport({
    ...
    auth: {
      user: 'kensender@mailo.com', // SMTP username
      pass: 'kenpassword', // SMTP password
    },
  });

  // Email options
  let mailOptions = {
    from: '"Kendrick Report" <coinreport@mailo.com>', // Sender address
    to: 'kendrickpaul@mailo.com', // List of recipients
